...
public class UmsMember implements Serializable {
    ...
    @ApiModelProperty(value = "vpn连击方式:1->ss;2->wireguard;3->openvpn")
    private Integer vpnConnectType;
    ...
    public Integer getVpnConnectType() {
        return vpnConnectType;
    }

    public void setVpnConnectType(Integer vpnConnectType) {
    ...
    public String toString() {
        ...
        sb.append(", vpnConnectType=").append(vpnConnectType);
